...
const CloseIcon = () => {
  ...
  return (
    <button
      className="absolute top-4 right-4 z-50 flex h-10 w-10 items-center justify-center bg-black/20 text-black/50 dark:bg-white/20 dark:text-white/50 rounded-full"
